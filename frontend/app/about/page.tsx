    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden">
        ...
        <div className="bg-slate-900/50 backdrop-blur-sm border-b border-white/10">
          <div className="flex justify-between items-center px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/detect" className="px-4 py-2 text-slate-300 hover:text-white hover:bg-white/10 rounded-full text-sm font-medium transition-all duration-300">
                Upload
              </Link>
      ...
      <div className="relative z-10 flex items-start justify-center min-h-[calc(100vh-120px)] px-6 pt-20">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-center">
          ...
          <Link 
            href="/detect"
            className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium rounded-xl hover:from-blue-400 hover:to-purple-400 transition-all duration-300 shadow-lg"
          >
            ← Back to Upload
          </Link>
        </div>
